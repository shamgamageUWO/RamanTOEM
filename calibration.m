...
% ylabel('Count ratio')
figure;semilogx(JLnew(Zi>500),Zi./1000,'r',NewJL,Zi./1000,'b');hold on
semilogx(JHnew(Zi>500),Zi./1000,'y',NewJH,Zi./1000,'g');hold off
...
% % % OVJH = JHreal./JH;
% % % Summation method
% OV = (JLnew(Zi>500) + JHnew(Zi>500))./(JLwoOV + JHwoOV);
