...
function [JL,JH,A_Zi,B_Zi,Diff_JL_i,Diff_JH_i,Ti]=forwardmodelnoOV(Q,x)
% Q.Zmes = 1000:100:40000;% Measurement grid
% Q.Zret = 1000:1000:40000;% Retrieval grid
% Q.date_in = date;%20110616; % daytime 20110816
% Q.time_in = 23;%23; % 11
...
A_Zi = (area .*R_tr_i .*Q.Pressi)./(kb * Q.Zmes .^2);
B_Zi = (area .*R_tr_i .*Q.Pressi)./(kb * Q.Zmes .^2);
