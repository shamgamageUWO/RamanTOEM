function [Q] = Qstructure( date_in,time_in,flag)
% makeQ(in)
...
% Gluing Coefficients(first run Glue.m and find these values)
Q.a_JL = 2.8345e3;
Q.b_JH = -8.0952e5;
Q.a_JH = 2.6236e3;
Q.b_JL = -1.6029e6;
...
Eb = Y.Eb;
Q.binzise = Y.binsize;
Q.Eb = Eb(alt>=1000 & alt<=60000);
Q.Eb(Q.Eb <=0)= rand();
Q.JHnew= JHnew(alt>=1000 & alt<=60000);
Q.JLnew= JLnew(alt>=1000 & alt<=60000);
Q.JH_DS =JH_DS(alt>=1000 & alt<=60000);
Q.JL_DS =JL_DS(alt>=1000 & alt<=60000);
Q.alt = alt(alt>=1000 & alt<=60000);
Q.Zmes2 = Q.alt';
...
Eba = Y.Eba;
ANalt = Y.alt_an;
Q.Eba = Eba(ANalt>=1000 & ANalt<=60000);
Q.Eba(Q.Eba <=0)= rand();
Q.JHnewa= JHnewa(ANalt>=1000 & ANalt<=60000);
Q.JLnewa= JLnewa(ANalt>=1000 & ANalt<=60000);
Q.ANalt = ANalt(ANalt>=1000);
Q.Zmes = Q.ANalt';
Q.Zmes1 = ANalt(ANalt>=1000 & ANalt<=60000);
Q.Zmes1 = Q.Zmes1';
