% Reads a ColIndex vector for a sparse matrix from an XML file.
%
%    Internal function that should never be called directly.
%    Use *xmlLoad* instead.
%
% FORMAT   result = xmlReadColIndex(fid, attrlist, itype, ftype, binary, fid2)
%
% OUT   result     ColIndexes
...
function result = xmlReadColIndex(fid, attrlist, itype, ftype, binary, fid2)
