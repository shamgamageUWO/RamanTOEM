% N_ICE_WISCOMBE   Complex refractive index for ice
%
...
%    240 K (set in wiscombe.f). However, the Wiscombe function has no
%    temperature below 167e-6.
%
% FORMAT   n = n_ice_wiscombe( lambda )
%        
...
function n = n_ice_wiscombe(lambda)

wiscombe;

b = interp1( ICE(:,1), ICE(:,2:3), lambda );
