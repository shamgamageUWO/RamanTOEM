% Three_phase_Maxwell_Gar     Effective refractive index and effective density of 
...
%                             Note that this function uses *Maxwell_Gar_mix_rule*
%                             function.

%                        
% 
% FORMAT     [n rho] = Three_phase_Maxwell_Gar(n1,n2,n3,rho1,rho2,rho3,fraction1, fraction2, fraction3)
%        
...
function [n rho]=Three_phase_Maxwell_Gar(n1,n2,n3,rho1,rho2,rho3,fraction1, fraction2, fraction3)
...
[n rho]=Maxwell_Gar_mix_rule(n2,n3,rho2,rho3,fraction);
...
[n rho]=Maxwell_Gar_mix_rule(n1,n,rho1,rho,fraction);
