function [effi_stoke,effi_anti,shift_N2_as,shift_N2_s,diff_N2s,diff_N2as]= RR_differentialN2_JH_transmission(J,T)
...
effi_stoke = [0.22742041,0.61706630,1,0.66219893,0.26342483,0.00549319];
effi_anti = [0.20278330,0.57977270,0.99609541,0.71343372,0.31181249,0.02739112];
