...
function [O,Q,R,S_a,Se,x_a] = InputsForOEMIterateVersion( date_in,time_in,flag,Input)
%set Q
[Q] = makeQIterateVersion( date_in,time_in,flag,Input);
%set O 
O = defOreal;
...
S_a = [Sa_Tnew Sa_BG_JH Sa_BG_JL Sa_CL' Sa_OV Sa_BG_JHa Sa_BG_JLa Sa_CLa' Sa_DT_JH' Sa_DT_JL'];% S_ainv = S_a^(-1);
